...
<div style="overflow: auto; width:100%-240px; height:100%; background: #f2f4f7;">
	<div class="watchbox">
		...
		<video src="./resources/contents/videos/<%=videoSrc %>" controls="controls" class="video-js vjs-default-skin" style="width:100%; height:100%; float:left; border:0px;" type="video/mp4">
		</video>
		</div>
